...
**Status:** Plans A–E landed (full design system foundation: tokens, typography, spacing, card system + pilot, tone matrix + pilot, page-header pattern + ApiStatus pilot). Per-component / per-route migrations are follow-up work.
