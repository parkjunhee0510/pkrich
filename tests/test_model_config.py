...
from src.utils.model_config import load_ensemble_config, load_model_profile, safe_input_token_budget
...
class ModelConfigTests(unittest.TestCase):
    ...
    def test_load_ensemble_config_reads_values(self) -> None:
        ...
        self.assertEqual(ensemble.third_model, 'standard')
        self.assertEqual(ensemble.third_prompt, 'research_v1')
